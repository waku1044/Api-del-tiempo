...
// 'lluvia ligera','nubes','nubes dispersas','cielo claro','lluvia de gran intensidad','lluvia moderada','muy nuboso','tormenta con lluvia'
...
//https://services.meteored.com/img/article/alerta-fuertes-lluvias-y-tormentas-en-el-litoral-fin-de-semana-340521-1_1280.jpg  8
...
console.log(ciudad)
 ...
 async function api(ciudad){   
    try {
         const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${ciudad === '' ? 'campana' : ciudad},AR&APPID=5af0f382c935c41627351f02286325a7&units=metric&lang=es`)
         const data = await response.json();
         console.log(data.weather[0].description)
         switch (data.weather[0].description) {
             case 'lluvia ligera':
                 img_tiempo.src = 'https://static.tiempo.com.mx/uploads/imagen/imagen/388071/principal_lluvia.jpg';
             ...
             case 'lluvia moderada':
                 ...
                 break;
             case 'muy nuboso':
                 img_tiempo.src = 'https://www.blogodisea.com/wp-content/uploads/2010/06/lluvia-cielo-nublado-plomizo-waxing-storm-campo.jpg';
                 img_tiempo.setAttribute('alt', 'muy nuboso');
                 break;
             case 'tormenta con lluvia':
                 img_tiempo.src = 'https://services.meteored.com/img/article/alerta-fuertes-lluvias-y-tormentas-en-el-litoral-fin-de-semana-340521-1_1280.jpg';
                 img_tiempo.setAttribute('alt', 'tormenta con lluvia');
                 break; 
         }
